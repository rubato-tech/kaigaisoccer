...
export const matches = mysqlTable(
  "matches",
  {
    ...
    /** 内部カテゴリ: euro_league(欧州主要リーグ), cup(各国カップ戦), uefa(CL/EL/ECL), national_team(代表戦), world_cup(W杯本大会) */
    category: mysqlEnum("category", ["euro_league", "cup", "uefa", "national_team", "world_cup"]).notNull(),
